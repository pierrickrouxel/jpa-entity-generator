...
public class EntityGeneratorTest {
    ...
    public void testGenerateEntity() throws IOException, URISyntaxException {
        ...
        var idColumn = Column.builder().name("ID").typeCode(4).typeName("INTEGER").autoIncrement(true).primaryKey(true).build();
    ...
    public void testGetClassInterfaceRules() {
        ...
        var articleInterfaces = List.of(Interface.builder().name("ArticleInterface").genericsClassNames(List.of("ArticleGeneric")).build());
        var blogInterfaces = List.of(Interface.builder().name("BlogInterface").genericsClassNames(List.of("BlogGeneric")).build());
        ...
        var entity = EntityGenerator.getEntity(table, EntityGeneratorConfig.builder().interfaceRules(interfaceRules).build());
    ...
    public void testGetFieldType() {
        assertThat(EntityGenerator.getFieldType("code", 4, "Article", Collections.emptyList()).toString()).isEqualTo("Integer");
    }
    ...
    public void testGetFieldTypeWithRules() {
        ...
        assertThat(EntityGenerator.getFieldType("code", 4, "Article", List.of(fieldTypeRule)).toString()).isEqualTo("String");
    }
    ...
    public void testGetFieldAnnotationRules() {
        ...
        var fieldAnnotationRules = List.of(
                FieldAnnotationRule.builder().className("Article").fieldName("name").annotations(articleNameAnnotations).build(),
